...
const services = [
  {
    ...
    features: ["E-COMMERCE", "SAAS", "CMS SUR MESURE", "OPTIMISATION SEO"],
  },
  {
    ...
    features: ["IOS & ANDROID", "UI/UX MOBILE", "API INTEGRATION", "OFFLINE MODE"],
  },
  {
    ...
    features: ["CROSS-PLATFORM", "HAUTE PERFORMANCE", "SÉCURITÉ", "LEGACY UPDATE"],
  },
  {
    ...
    features: ["NLP", "COMPUTER VISION", "PREDICTIVE ANALYTICS", "GEN AI"],
  },
];
...
export default function Services() {
  ...
  return (
    <div className="min-h-screen bg-[#1f212d] text-white font-sans overflow-x-hidden">
      ...
      {/* SERVICE CARDS */}
      <section className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-16 pb-24">
